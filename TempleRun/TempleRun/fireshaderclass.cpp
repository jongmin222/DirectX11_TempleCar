...
bool FireShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, XMMATRIX worldMatrix, XMMATRIX secondWorldMatrix, XMMATRIX  viewMatrix,
...
bool FireShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX secondWorldMatrix, XMMATRIX  viewMatrix,
	XMMATRIX  projectionMatrix, ID3D11ShaderResourceView* fireTexture,
...
void FireShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount)
{
