...
void FireModelClass::SetInstanceCount(int count)
{
...
bool FireModelClass::ReadFileCounts(const WCHAR* filename)
{
	ifstream fin;
	char input;
...
bool FireModelClass::LoadDataStructures(const WCHAR* filename, int vertexCount, int textureCount, int normalCount, int faceCount)
{
