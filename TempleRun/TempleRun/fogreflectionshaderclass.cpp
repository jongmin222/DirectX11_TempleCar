////////////////////////////////////////////////////////////////////////////////
// Filename: fogreflectionshaderclass.cpp
////////////////////////////////////////////////////////////////////////////////
#include "fogreflectionshaderclass.h"


FogReflectionShaderClass::FogReflectionShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
FogReflectionShaderClass::FogReflectionShaderClass(const FogReflectionShaderClass& other)
{
}
...
bool FogReflectionShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"./data/fogreflection.vs", L"./data/fogreflection.ps");
	if (!result)
	{
		return false;
	}
...
void FogReflectionShaderClass::Shutdown()
{
...
bool FogReflectionShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, XMMATRIX worldMatrix, XMMATRIX secondWorldMatrix,
	XMMATRIX  viewMatrix, XMMATRIX  projectionMatrix, ID3D11ShaderResourceView* texture,
	XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor,
	XMFLOAT4 clipPlane, float fogStart, float fogEnd)
{
	bool result;


	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, secondWorldMatrix, viewMatrix, projectionMatrix, texture, lightDirection, ambientColor,
		diffuseColor, clipPlane, fogStart, fogEnd);
	if (!result)
	{
		return false;
	}
...
bool FogReflectionShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename)
{
	HRESULT result;
...
void FogReflectionShaderClass::ShutdownShader()
{
...
void FogReflectionShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, const WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool FogReflectionShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX secondWorldMatrix, XMMATRIX  viewMatrix,
...
void FogReflectionShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount)
{
