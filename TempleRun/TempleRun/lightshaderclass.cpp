...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext/*, int indexCount*/, int vertexCount, int instanceCount,
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename)
{
	...
	D3D11_INPUT_ELEMENT_DESC polygonLayout[5/*¿ø·¡3*/];
...
void LightShaderClass::RenderShader(ID3D11DeviceContext* deviceContext,/* int indexCount*/int vertexCount, int instanceCount)
{
